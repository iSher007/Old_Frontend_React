...
const Report1 = () => {
    ...
    const onRegenerateClick = () => {
        ...
        axios.get(`https://fastapi-production-fffa.up.railway.app/Gallup/${pdfId}/report1?regenerate=true`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
    ...
    return (
        <div className="container">
            <div className="row">
                <div className="col-12 d-flex d-md-none my-3">
                    <button onClick={onRegenerateClick} className='btn btn-danger me-2' style={{ marginTop: '10px', left: '0' }}>Regenerate</button>
