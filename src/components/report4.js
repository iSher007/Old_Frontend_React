...
const Report4 = () => {
    ...
    useEffect(() => {
        axios.get(`https://fastapi-production-fffa.up.railway.app/Gallup/${pdfId}/school_reports`, {
            ...
            params: {
                num_report: 4, // Directly sending integer 1 for num_report
            },
        })
            .then((response) => {
        ...
        <div className="report1-container">
            {isLoading ? (
                <div className="card card-custom h-100 p-3 d-flex flex-column align-items-center">
                    <h1>Карта Карьерного Развития</h1>
                    <ul className="content-list">
                        <li><strong>Наиболее подходящие профессии:</strong> - профессии, где ваши таланты смогут раскрыться лучше всего</li>
                        <li><strong>Наименее подходящие профессии:</strong> - Некоторые профессии из списка сфер оказались менее подходящими</li>
                    </ul>
